# -*- coding: utf-8 -*-
"""
Created on Thu Jan 21 13:57:00 2016
...
#DR_name='DR.txt'
#
#data = np.loadtxt('/Users/seshadri/Workspace/structures/BigMDPl/CMASS/IsolatedVoids_info.txt',skiprows=2)	
#pos_g=data[:,1:4]
#points_g = len(pos_g)
#points_r = 10*len(pos_g)
#pos_r=np.random.random((points_r,3))*BoxSize
#	
#start=time.clock()
#r,xi_r,error_xi=TPCF(pos_g,pos_r,BoxSize,DD_action,RR_action,DR_action,DD_name,RR_name,DR_name,bins,Rmin,Rmax,verbose=False)
#	
#plt.errorbar(r,xi_r,yerr=error_xi,color='k',markeredgecolor='none',markersize=8,fmt='o')
#plt.savefig('/Users/seshadri/Workspace/figures/BigMDPl/figure.pdf',bbox_inches='tight')
#end=time.clock()
